# database/db.py — Conexão central com PostgreSQL
...
async def init_db():
    ...
    async with pool.acquire() as conn:
        ...
        # Tabela treino uso (limite diário)
        await conn.execute("""
