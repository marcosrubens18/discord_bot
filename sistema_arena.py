# sistema_arena.py — Sistema de Arenas Ranqueadas PvP (1v1 apenas)
...
from sistema_combate import rodar_pvp, BATALHAS_ATIVAS
from constants import COR_PRIMARY, COR_SUCCESS, COR_DANGER, COR_WARNING, COR_INFO, COR_GOLD, ARENAS, ELOS, DESAFIOS_POR_DIA
