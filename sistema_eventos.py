# sistema_eventos.py — Sistema de Eventos completo com contabilização automática
...
from constants import TIPOS_EVENTO, TIPOS_PREMIO, COR_PRIMARY, COR_SUCCESS, COR_DANGER, COR_WARNING, COR_INFO
