# sistema_dungeon.py — Sistema de Dungeons com Lock e integração com Party
...
from data_dungeons import RANKS_DUNGEON
...
from sistema_combate import (
    ...
    get_arma_equipada, get_armadura_equipada, calcular_bonus_equip
)
...
async def salvar_resultado_dungeon(user_id, hp_final, xp_total, classe_id, nivel):
    ...
    async with pool.acquire() as conn:
        ...
        try:
            from sistema_eventos import registrar_dungeon_evento
