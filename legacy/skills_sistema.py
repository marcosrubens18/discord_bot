# skills_sistema.py — Sistema completo de skills com raridades e efeitos reais
...
"escudo_de_aço": {
    ...
    "raridade": "Épico", "emoji": "🪨", "mana": 35, "dano_mult": 0,
    "efeito": "escudo_total",
...
"furia_berserker": {
    ...
    "raridade": "Épico", "emoji": "🔥", "mana": 40, "dano_mult": 1.5,
    "efeito": "berserker",
...
"campo_forca": {
    ...
    "raridade": "Épico", "emoji": "🔮", "mana": 30, "dano_mult": 0,
    "efeito": "reflexo",
...
"sobrecarga_arcana": {
    ...
    "raridade": "Épico", "emoji": "🌟", "mana": 60, "dano_mult": 3.5,
    "efeito": "sobrecarga",
...
"tiro_fantasma": {
    ...
    "raridade": "Épico", "emoji": "👻", "mana": 50, "dano_mult": 2.5,
...
"ressureicao": {
    ...
    "raridade": "Épico", "emoji": "✝️", "mana": 80, "dano_mult": 0,
    "efeito": "ressurreicao",
...
"juizo_final": {
    ...
    "raridade": "Épico", "emoji": "☀️", "mana": 60, "dano_mult": 3.0,
...
"exercito_mortos": {
    ...
    "raridade": "Épico", "emoji": "💀", "mana": 55, "dano_mult": 2.2,
...
"abraço_da_morte": {
    ...
    "raridade": "Épico", "emoji": "💀", "mana": 65, "dano_mult": 1.0,
...
"forma_menor_dragao": {
    ...
    "raridade": "Épico", "emoji": "🌋", "mana": 45, "dano_mult": 0,
    "efeito": "buff_all",
...
"dragao_eterno": {
    ...
    "raridade": "Épico", "emoji": "💎", "mana": 70, "dano_mult": 4.0,
...
"tempestade_arcana": {
    ...
    "raridade": "Épico", "emoji": "⭐", "mana": 55, "dano_mult": 2.5,
    "efeito": "multi_hit",
...
"singularidade": {
    ...
    "raridade": "Épico", "emoji": "🕳️", "mana": 75, "dano_mult": 5.0,
...
"muralha": {
    ...
    "raridade": "Épico", "emoji": "🪨", "mana": 50, "dano_mult": 0,
    "efeito": "escudo_total",
...
def get_skills_da_classe(classe_id):
    """Retorna todas as skills de uma classe + suporte"""
    return {
        sid: s for sid, s in SKILLS.items()
        if s["classe"] == classe_id or s["classe"] == "suporte"
    }

def skill_desbloqueada(skill, nivel_jogador):
    return nivel_jogador >= skill["nivel"]

def formatar_skill_embed(skill_id, skill, desbloqueada=True, equipada=False):
    rar = skill["raridade"]
    status = "🟢 Equipada" if equipada else ("✅ Disponível" if desbloqueada else f"🔒 Nível {skill['nivel']}")
    mana_txt = f"{skill['mana']} 💙" if skill["mana"] > 0 else "Sem custo"
    dano_txt = f"x{skill['dano_mult']}" if skill["dano_mult"] > 0 else "Suporte"
    hits = skill.get("hits", 1)
    hits_txt = f" × {hits} hits" if hits > 1 else ""

    return (
        f"{EMOJI_RAR[rar]} {skill['emoji']} **{skill['nome']}** [{rar}] — {status}\n"
        f"└ 💙 {mana_txt} | ⚔️ {dano_txt}{hits_txt}\n"
        f"└ *{skill['desc']}*\n"
    )
