# passe_temporada.py — Sistema de Passe de Temporada (Battle Pass)
import discord
...
# ==================================================
# RECOMPENSAS DO PASSE (25 NÍVEIS)
# ==================================================
...
def register_passe_commands(bot):
    ...
    @app_commands.autocomplete(tipo=autocomplete_tipo_recompensa_admin)
