# systems/passe.py — Sistema de Passe de Temporada (Battle Pass)
...
async def get_progresso(user_id: int, temporada_id: int = None) -> dict:
...
async def adicionar_pontos_passe(user_id: int, pontos: int, fonte: str = "batalha") -> dict:
