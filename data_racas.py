# data_racas.py — Sistema de Racas completo (REBALANCEADO TEMPORADA 2)
...
RACAS = {
    ...
    "humano": {
        ...
        "passiva_desc": "+10% XP e +5% moedas em batalhas e dungeons",
        "bonus_xp": 0.10,
        "bonus_moedas": 0.05,
        "cor": 0x888780,
        "cargos": "👤 Humano",
    ...
    "anao": {
        ...
        "passiva_desc": "+5 DEF fixo, 50% de resistência a atordoamento",
        "bonus_def": 5,
    ...
    "draconiano": {
        ...
        "passiva_desc": "-12% dano recebido, imune queimadura, +10% dano de fogo",
        "cor": 0xE67E22,
        "cargos": "🐉 Draconiano",
    },
    "anjo": {
    ...
    "demonio": {
        ...
        "passiva_desc": "Primeiros 10 turnos: +5% dano/turno (max +50%). Ataques causam queimadura",
        "cor": 0xC0392B,
        "cargos": "😈 Demônio",
    },
}
...
RACAS_ROLETA = [r for r in RACAS.values() if r.get("peso", 0) > 0]

EMOJI_RAR_RACA = {"Comum": "⬜", "Incomum": "🟩", "Raro": "🟦", "Epico": "🟪", "Lendario": "🟧"}
COR_RAR_RACA = {"Comum": 0x888780, "Incomum": 0x1D9E75, "Raro": 0x378ADD, "Epico": 0x7F77DD, "Lendario": 0xD85A30}
