...
# ─── CATALOGO COMPLETO PARA AUTOCOMPLETE ─────────────────────────

POCOES_CAT = [
    {"id":"pocao_hp_p","nome":"Pocao de Cura P","emoji":"🧪","tipo":"pocao","raridade":"Comum","desc":"Recupera 30 HP","preco":30},
    {"id":"pocao_hp_m","nome":"Pocao de Cura M","emoji":"💊","tipo":"pocao","raridade":"Comum","desc":"Recupera 60 HP","preco":60},
    {"id":"pocao_hp_g","nome":"Pocao de Cura G","emoji":"❤️","tipo":"pocao","raridade":"Raro","desc":"Recupera 120 HP","preco":120},
    {"id":"pocao_mana_p","nome":"Pocao de Mana P","emoji":"🔵","tipo":"pocao","raridade":"Comum","desc":"Recupera 20 Mana","preco":25},
    {"id":"pocao_mana_m","nome":"Pocao de Mana M","emoji":"💙","tipo":"pocao","raridade":"Incomum","desc":"Recupera 50 Mana","preco":55},
    {"id":"elixir","nome":"Elixir Supremo","emoji":"✨","tipo":"pocao","raridade":"Epico","desc":"HP e Mana full","preco":300},
]
MATERIAIS_CAT = [
    {"id":"pedra_suja","nome":"Pedra Suja","emoji":"🪨","tipo":"material","raridade":"Comum","desc":"Material basico","preco":0},
    {"id":"pele_lobo","nome":"Pele de Lobo","emoji":"🐾","tipo":"material","raridade":"Comum","desc":"Material comum","preco":0},
    {"id":"minerio_ferro","nome":"Minerio de Ferro","emoji":"⛏️","tipo":"material","raridade":"Comum","desc":"Metal bruto","preco":0},
    {"id":"osso_oco","nome":"Osso Oco","emoji":"💀","tipo":"material","raridade":"Incomum","desc":"Material necrotico","preco":0},
    {"id":"dente_orc","nome":"Dente de Orc","emoji":"🦷","tipo":"material","raridade":"Incomum","desc":"Ingrediente","preco":0},
    {"id":"fragmento_golem","nome":"Fragmento de Golem","emoji":"🪨","tipo":"material","raridade":"Raro","desc":"Material magico","preco":0},
    {"id":"sangue_anciao","nome":"Sangue Anciao","emoji":"🩸","tipo":"material","raridade":"Raro","desc":"Ingrediente raro","preco":0},
    {"id":"nucleo_pedra","nome":"Nucleo de Pedra","emoji":"💎","tipo":"material","raridade":"Raro","desc":"Material magico raro","preco":0},
    {"id":"essencia_sombria","nome":"Essencia Sombria","emoji":"🌑","tipo":"material","raridade":"Raro","desc":"Ingrediente sombrio","preco":0},
    {"id":"pena_grifo","nome":"Pena de Grifo","emoji":"🦅","tipo":"material","raridade":"Raro","desc":"Material de voo","preco":0},
    {"id":"escama_dragao_p","nome":"Escama de Dragao","emoji":"🐉","tipo":"material","raridade":"Raro","desc":"Fragmento de escama","preco":0},
    {"id":"olho_dragao","nome":"Olho de Dragao","emoji":"👁️","tipo":"material","raridade":"Epico","desc":"Material epico","preco":0},
    {"id":"essencia_lich","nome":"Essencia do Lich","emoji":"💀","tipo":"material","raridade":"Lendario","desc":"Material sombrio","preco":0},
    {"id":"fragmento_titan","nome":"Fragmento do Titan","emoji":"🗿","tipo":"material","raridade":"Lendario","desc":"Lendario","preco":0},
    {"id":"essencia_criador","nome":"Essencia do Criador","emoji":"🌌","tipo":"material","raridade":"Lendario","desc":"Transcendente","preco":0},
]

def get_catalogo_completo():
    """Retorna todos os itens do catalogo com chave unica tipo:classe:id."""
    todos = []
    for cls, armas in ARMAS_POR_CLASSE.items():
        for a in armas:
            todos.append({
                ...
                "desc": a.get("desc",""), "preco": a.get("preco",0)
            })
    ...
    for p in POCOES_CAT:
        todos.append({**p, "chave": f"pocao::{p['id']}", "classe": ""})
    for m in MATERIAIS_CAT:
        todos.append({**m, "chave": f"material::{m['id']}", "classe": ""})
    return todos

def get_item_por_chave(chave: str):
    """Busca um item pelo sua chave unica."""
...
def get_itens_por_categoria(categoria: str):
    """Retorna itens filtrados pela categoria do set-item."""
